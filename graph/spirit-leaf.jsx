// spirit-leaf.jsx — The journal leaf for /graph/spirit.html
...
// drop cap, no gold flourish) — Spirit's deliberate v1 choice per the
...
// ── SpiritLeaf — the whole leaf (spread or single) ─────────────────────────
const SpiritLeaf = ({ entry, layout, turning }) => {
  ...
  return (
    <div className={'spirit-leaf ' + (turning ? 'turning ' + turning : '')} style={{
      width: isSpread ? 'min(100%, 1080px)' : 'min(100%, 760px)',
      margin: '0 auto',
      perspective: 2200,
      transformStyle: 'preserve-3d',
    }}>
      <div className="spirit-leaf-bleed" style={{
        position: 'relative',
        ...
        {isSpread ? (
          <div className="spirit-spread" style={{
            display: 'grid',

...
window.TESTS = [
  ...
  {"id":"tc-history","file":"tests/tc-history.test.mjs","title":"Our-History month-graph set — per-type group","tier":1,"issue":335,"notes":"","highlight":"Our-History month-graph set — per-type group","status":"live","covers":["@HISTORY pages (month-graph set)"],"ignores":["interactive graph runtime — runtime / Tier 4 (#306)","HISTORY / PORTFOLIO membership — editorial"]},
  ...
  {"id":"tc-index","file":"tests/tc-index.test.mjs","title":"Homepage — index.html standalone contract","tier":1,"issue":340,"notes":"","highlight":"Homepage — index.html standalone contract","status":"live","covers":["index.html","components/HomeMain.jsx"],"ignores":["window.NOW — editorial (weekly-cadence focus list; the #401/#403 case)","content snapshot — editorial","live feed / graph correctness — owned: #336 / #364; runtime / Tier 4"]},
  ...
  {"id":"tc-portfolio","file":"tests/tc-portfolio.test.mjs","title":"Portfolio — portfolio.html standalone contract","tier":1,"issue":341,"notes":"","highlight":"Portfolio — portfolio.html standalone contract","status":"live","covers":["portfolio.html"],"ignores":["content snapshot — editorial","evidence-graph compute — runtime / Tier 4 (#306)","live feed values — owned: #364"]},
  ...
  {"id":"tc-spirit","file":"tests/tc-spirit.test.mjs","title":"TC — spirit organ page structure + wiring","tier":1,"issue":337,"notes":"standalone","highlight":"TC — spirit organ page structure + wiring","status":"live","covers":["graph/spirit.html"],"ignores":["content snapshot — editorial","live values — runtime / Tier 4","shared fetch read-path — owned: #336"]},

...
window.TESTS = [
  ...
  {"id":"tc-immune-system","file":"tests/tc-immune-system.test.mjs","title":"TC — immune-system data feed: window.IMMUNE schema","tier":1,"issue":380,"notes":"standalone","highlight":"TC — immune-system data feed: window.IMMUNE schema","status":"live","covers":["graph/immune-data.js (window.IMMUNE schema v1)"],"ignores":["metric values + array lengths — runtime / recomputed data","graph/immune.html (organ page) — owned: #318","acceptance spot-checks (history-coupled) — editorial"]},

...
window.TESTS = [
  {"id":"smoke","file":"tests/smoke.test.mjs","title":"Smoke test — proves the runner discovers, executes, and reports a TC.","tier":0,"issue":294,"notes":"","highlight":"Smoke test — proves the runner discovers, executes, and reports a TC.","status":"live"},
  {"id":"tc-about","file":"tests/tc-about.test.mjs","title":"About-section — per-type group contract","tier":1,"issue":344,"notes":"","highlight":"About-section — per-type group contract","status":"live"},
  {"id":"tc-agent-live","file":"tests/tc-agent-live.test.mjs","title":"TC — agent-page live layer","tier":1,"issue":342,"notes":"per-type, extends TC2","highlight":"TC — agent-page live layer","status":"live"},
  {"id":"tc-articles","file":"tests/tc-articles.test.mjs","title":"Articles — per-type group contract","tier":1,"issue":332,"notes":"","highlight":"Articles — per-type group contract","status":"live"},
  {"id":"tc-competency","file":"tests/tc-competency.test.mjs","title":"Competency evidence integrity — data.js","tier":1,"issue":333,"notes":"","highlight":"Competency evidence integrity — data.js","status":"live"},
  {"id":"tc-faces-dashboard","file":"tests/tc-faces-dashboard.test.mjs","title":"TC — faces + dashboard live agent-grid structure","tier":1,"issue":339,"notes":"standalone","highlight":"TC — faces + dashboard live agent-grid structure","status":"live"},
  {"id":"tc-github-activity","file":"tests/tc-github-activity.test.mjs","title":"GitHub activity-feed read-path wiring","tier":1,"issue":364,"notes":"cross-cutting","highlight":"GitHub activity-feed read-path wiring","status":"live"},
  {"id":"tc-heart","file":"tests/tc-heart.test.mjs","title":"TC — heart organ + journal page pair","tier":1,"issue":338,"notes":"standalone","highlight":"TC — heart organ + journal page pair","status":"live"},
  ...
  {"id":"tc-trackers","file":"tests/tc-trackers.test.mjs","title":"TC — house tracker pages structure + wiring","tier":1,"issue":343,"notes":"standalone","highlight":"TC — house tracker pages structure + wiring","status":"live"},
  {"id":"tc-webform","file":"tests/tc-webform.test.mjs","title":"TC — data-entry webform WRITE-path wiring","tier":1,"issue":345,"notes":"cross-cutting","highlight":"TC — data-entry webform WRITE-path wiring","status":"live"},
  {"id":"tc1-page-chrome","file":"tests/tc1-page-chrome.test.mjs","title":"TC1 — Universal page-chrome contract","tier":1,"issue":298,"notes":"","highlight":"TC1 — Universal page-chrome contract","status":"live"},
  {"id":"tc2-agent-completeness","file":"tests/tc2-agent-completeness.test.mjs","title":"TC2 — Agent completeness + roster coherence","tier":1,"issue":299,"notes":"","highlight":"TC2 — Agent completeness + roster coherence","status":"live"},
  {"id":"tc3-organ-structural","file":"tests/tc3-organ-structural.test.mjs","title":"TC3 — Organ-structural contract (per-type)","tier":1,"issue":300,"notes":"","highlight":"TC3 — Organ-structural contract (per-type)","status":"live"}
];
// TESTS:GENERATED END

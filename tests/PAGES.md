...
| `graph/spirit.html` | #336 `tc-live-display`, #337 `tc-spirit`, #300 `tc3-organ-structural` | live values (runtime / Tier 4); GitHub activity feed (owned: #364 (different live source)); content snapshot (editorial); shared fetch read-path (owned: #336); live read-path (owned: #336); organ-specific content (owned: #337 / #338 / #339) |
| `graph/stomach.html` | #300 `tc3-organ-structural` | live read-path (owned: #336); organ-specific content (owned: #337 / #338 / #339) |
| `index.html` | #364 `tc-github-activity`, #340 `tc-index`, #336 `tc-live-display` | feed values (runtime / Tier 4); window.NOW (editorial (weekly-cadence focus list; the #401/#403 case)); content snapshot (editorial); live feed / graph correctness (owned: #336 / #364; runtime / Tier 4); live values (runtime / Tier 4); GitHub activity feed (owned: #364 (different live source)) |
| `portfolio.html` | #364 `tc-github-activity`, #341 `tc-portfolio` | feed values (runtime / Tier 4); content snapshot (editorial); evidence-graph compute (runtime / Tier 4 (#306)); live feed values (owned: #364) |
...
| `writing/building-while-i-sleep.html` | #332 `tc-articles`, #456 `tc-building-while-i-sleep` | content quality (editorial); HISTORY month files (owned: #335 (data-derived exemption)); interactive-graph runtime (runtime / Tier 4 (#306)); locked copy verbatim / all copy values (editorial); alt-text exact wording (editorial); recruiter-widget row (no bench-enforced data source; build-scope per #456); chrome, SITE_INDEX, favicon, static description (owned: #298 (tc1)); ARTICLES metadata shape & bijection (owned: #332 (tc-articles)) |
